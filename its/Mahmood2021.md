...
* 
1. OLSR
	* 最初，使用稱為多點中繼 (MPR) 的特定節點，OLSR 減少了控制流量氾濫的消耗。在 MPR 中，只選擇那些提供從源頭到目的地的最佳路徑的通訊節點，因此 MPR 有助於控制流量。
	* 在 OLSR 要求中，只有部分連結狀態被氾濫，目的是呈現最短路徑。
	* OLSR 鄰居列表可以在與相鄰車輛/節點定期交換其連結狀態資訊後從相鄰節點獲得的最新信息。
* 
