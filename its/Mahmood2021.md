...
2. DSDV
	...
	* DBF 中所有單個節點都保持到達每個熟悉目的地的成本。因此，DBF 包含路由表中的進入點。路由表一開始沒有進入點，所有節點開始向其 1-hope 鄰居發出週期性廣播消息。此協議的主要缺點是會導致計數到無窮大及迴圈問題。如果有關最短路徑評估的資料過時，則可能會出現迴圈。DSDV 起源的主要目的是避免形成回ㄑㄩㄢ。
