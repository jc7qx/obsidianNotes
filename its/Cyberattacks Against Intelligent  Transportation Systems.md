...
網路互連的ITS生態系統尚未完全實施。距離完全互連每輛車和每條道路的ITS系統至少還需要十年的時間才可能實現。但即使有當前的ITS基礎設施到位，隨著更多連接的ITS系統上線，攻擊事件越來越多。本節中，看到有一些針對ITS系統的真實世界資通攻擊事件已成為最近的新聞頭條。

* 2016年5月23日「達拉斯新聞」報導了一名德州男子駭客更改高速公路標誌，寫著「Drive Crazy Yall」作為惡作劇。罪魁禍首確定為 Geoffrey Eltgroth 遭到逮捕被指控刑事惡作劇。Eltgroth 承認猜測該號誌的登錄憑證，刪除警告即將施工的原始訊息，並輸入惡作劇消息為幽默目的。
* 2016年6月6日「華盛頓郵報」報導，達拉斯的道路標誌被駭客入侵，並貼上關於唐納德特朗普，伯尼桑德斯和哈蘭貝大猩猩訊息。德州交通部門對被駭的訊息顯示板做出回應，稱他們屬於私人承包商，正在調查他們是如何被駭客入侵？
* 2016年11月26日「San Francisco Examiner 」媒體報導，舊金山市政運輸機構 (Muni) 遭到加密勒索軟體攻擊，在系統上顯示駭客的訊息。該訊息提到一個電子郵件地址，被連結到惡意軟體的攻擊，例如 HDDCryptor。除此之外，位於Muni地鐵站的付費機顯示「停止服務」訊息。 無法向客戶收費，Muni 允許免費乘坐其輕軌車輛。
* 2017年1月27日「華盛頓郵報」報導，70% 的儲存資料設備，記錄來自華盛頓特區的警察監控攝影機，在川普總統的就職典禮八天前，感染了勒索軟體。勒索軟體使當地警方1月12日至15日無法記錄，187台網路攝影機中123台受到影響。
* 2017年4月9日「美國有線電視新聞網」報導，駭客11:40在達拉斯，觸發所有156個緊急警報器，緊急警報器僅使用無線電通訊，控制中心和警報器沒有網路連接。駭客操縱無線電通訊獲得控制權觸發警報器。雖然這不是直接針對ITS基礎設施的資通攻擊，但達拉斯居民撥打911使得緊急系統阻塞數小時，反過來又直接影響緊急車輛管理系統。
* 2017年4月21日。「RP 線上」報導，計劃對 Rheinbahn(德國杜塞爾多夫的公共運輸通公司)系統升級，路線和時刻表系統出現嚴重錯誤導致公車和火車服務大規模延誤和取消，造成公眾不便。在80多條路線，總共832部車輛因系統升級失敗受到影響。司機不得不在公車和火車頭前面放置手寫告示，因原先的數位標誌顯示不正確訊息。雖然這不是ITS資通攻擊，但清楚地表明這類型事件會同樣產生有害的後果。
* 2017年5月13日「自由電台」報導，俄羅斯鐵路公司電腦感染WannaCry勒索軟體。在最初爆發的一天，WannaCry就在150國家感染超過200,000台電腦。俄羅斯鐵路公司證實感染是局部的，鐵路交通不受影響。「每日電訊報」報導，WannaCry感染了德國火車站，乘客資訊螢幕上顯示Wanna勒索視窗。 Deutsche Bahn表示，由於木馬攻擊導致各領域系統故障。WannaCry是一種勒索軟體，利用 SMB 漏洞 (MS17-010) 傳播和感染未修補的系統，要求300元比特幣贖金以解密。如果一周內沒有收到付款，那麼系統上的所有加密文件將被刪除。任何機構使用未修補或舊版本視窗作業系統，可能成為 WannaCry的受害者。
* 2017年5月17日「今日美國」報導，華盛頓特區聯合車站的資訊顯示螢幕被駭，並在尖峰時播放 Pornhub的視頻。監視器已迅速關掉，當局尚未分享有關此安全漏洞事件的更多細節。
* 2017年7月26日「Motherboard」報告，安全研究人員在網路連結的免下車洗車機發現了漏洞，這些漏洞可以讓駭客遠程劫持系統，實際攻擊車輛及乘員。駭客可以控制艙門並使它們撞擊進入/離開洗車場的車輛，或將車輛困在洗車場內，過程中損壞車輛傷害乘員。洗車機沒有整合到ITS和被駭洗車機實際上造成的損害有限，我們仍將其列表在真實世界的攻擊，因受損的網路連結系統可能危及車輛和駕駛安全。
* 2017年8月4日「Autoblog」報導，一群大學研究員發現在道路號誌上貼貼紙，可使自動駕駛汽車被駭。研究人員分析被用在自駕車的視覺系統中的圖像分類演算法，使用貼紙以操縱道路標示視覺，為要誘騙機器學習模型進入誤導。在一個例子中，他們使用貼紙欺騙自駕車的視覺系統，將 STOP標誌讀成每小時45英里的標誌。這種簡單攻擊在真實世界中的後果可能是毀滅性的，尤其現在許多道路車輛都具有半自動駕駛能力。
* 2017年8月4至7日，據報導，加州發生了多起高速公路訊息顯示板被駭事件。發布攻擊性訊息包括：“川普患有皰疹”、“前方有免費妓女”和“小心亞洲駕駛”。在一事件，已使用密碼保護的電子訊息顯示板，駭客仍可繞過密碼發布訊息。雖然這些可能是惡作劇，卻可以分散駕駛注意力危害道路安全。

列出的一些事件雖可歸因簡單的破壞行為，但事實仍然是ITS技術很容易受到此類攻擊，並可能引起資通犯罪份子的注意。

已在起草立法強制執行 V2V 和 V2I 通信。一旦這些立法通過和制定標準，ITS元件互相連接將快速發生。自動駕駛汽車目前處於早期發展階段，但隨著大量投資湧入，將使自動駕駛汽車在路上行駛快速發展。當整合和互連正在慢慢達成，ITS顯然必須對抗資通攻擊。這強調了在一開始ITS安全的重要性，畢竟ITS不僅會影響經濟收益，還會影響公共安全。
...
哪裡有機會，哪裡就有犯罪者攻擊！攻擊者通常藉著，如金錢、報復、和抗議等各種理由，運用以小博大、偷竊、博弈和濫用系統等策略發動資通攻擊(Cyber Attacks)，本節將討論對ITS基礎設施構成威脅的不同類型犯罪者。

國家政府 — 已開發國家和開發中國家都使用間諜軟體工具和客制化惡意程式收集情報。根據我們對當前資通攻擊的觀察，國家支持攻擊的主要目標是竊取智慧財產或贏得競爭優勢。但在某些情況下，例如在戰爭期間，一個國家可以破壞另一個國家的ITS基礎設施。國家支持的攻擊遵循兩種作案手法之一，一則國家直接控制駭客團隊和他們的資源，另一就是將駭客活動外包給第三方如犯罪幫派來執行，以推諉其責任。

犯罪幫派 — 高級技術駭客團隊，由有組織的犯罪團體資助和控制，使用勒索軟體、網路釣魚、偷渡式下載等不同的方式攻擊受害者，為幫派創造非法獲利。還有一些駭客組織與各國政府建立契約進行各種政治目的的資通攻擊，包括資安間諜活動和託辭（cyber espionage and subterfuge）。

激進駭客 — 網路激進份子攻擊資通資產，為引起人們對其政治原因的關注，傾向於選擇高度可見、引人注目的目標。ITS基礎設施像高速公路數位訊息顯示板經常成為駭客目標，抗議原因諸如環境、政治、企業貪婪等。

資通恐怖分子 — 他們的目標是發起引起混亂的或破壞性的資通攻擊，以造成實際財產或生命損失和散佈恐怖。

內部人員 — 內部人員的動機很難破解。對他們現在的或曾經待過的組織採取間接活動違反他們自己的利益。他們對抗違反他們自身利益的組織，不論是現在的、過去德、或間接的組織。內部人士可能會受到金錢、意識形態、脅迫、自私、報復和政治的鼓動。可能超過一個上述的動機致使內部人員發動攻擊。

不道德的運營商 — ITS基礎設施的主要使用者是司機。這包括一般駕駛和商用車輛運營商。不難想像一般駕駛和商業運營商試圖駭入和玩弄系統以節省罰款和費用，以便在交通上領先，破壞競爭對手等。

自然災害 — 大雪、豪雨、強風和其他自然現象可能導致系統故障，這有效地削弱ITS基礎設施功能性。一個例子是溫哥華的全自動Skytrain運輸系統，每當該地區大雪，系統就會減慢速度或關閉，因為冰雪使軌道上的入侵感測器失效，使火車停下來。Skytrain的解決方案是在大雪期間手動行駛火車，這本身是緩慢過程。

除了自然災害和道路使用者，我們可以看到對ITS常見的資通攻擊和日常犯罪者對組織、政府和關鍵基礎設施的線上系統攻擊沒有不同。雖然看起來保護ITS基礎設施是容易的，實際上並不簡單。ITS生態系統不斷發展，威脅也不斷擴大。不難想像，未來新的肇事者將出現，就像我們今天不認為是威脅，例如人工智慧技術的影響。

------

ITS 攻擊者動機

從攻擊者本身出發，來考察他們的動機。我們每天看到絕大多數資通攻擊者的主要動機是「金錢」。但在ITS的世界，不是所有攻擊者攻擊ITS生態系統是被錢驅動。ITS系統是高度可見，對它們的攻擊會影響很大。這本身就是許多攻擊者的關鍵動機。我們已經確定了五個廣泛的目標和暴利模式，會激勵犯罪者攻擊ITS生態系統。

贖金 — 攻擊者可以對資料和系統檔案加密，並要求支付贖金以提供解密金鑰。這將嚴重影響ITS的日常運作，影響收入、公司信譽，並可能關閉負責公共安全的關鍵系統。設計不佳的勒索軟體惡意軟體還會不可逆地破壞資料和系統檔案，即便使用解密金鑰也無法恢復。未來，可預期攻擊者將設計發送惡意韌體方法，升級到隔空傳遞(Over The Air,  OTA)給連結的汽車，使車輛功能失效直到車主支付贖金。當OTA勒索軟體攻擊連結的汽車正在道路上行駛，將嚴重影響車內乘客和路上其他車輛的安全。

資料偷竊 — 攻擊者可以竊取專利資料、智慧財產權、企業營運資料、個人身份資訊 (Personal Identification Information, PII)、財務資料、銷售資料、客戶資訊、貨物資料、車輛追踪資訊等。並以各種方式將被盜資料貨幣化。被盜資料可用於身份盜竊、侵犯隱私、金融欺詐、工業間諜活動和其他與資訊盜竊有關的犯罪/威脅。兩個最有可能竊取資料者是國家組織和不道德的競爭對手。他們的目標包括（但不限於）獲得競爭優勢，尤其是投標，複製昂貴研究，標識經營弱點，改善自己的業務流程等。

資訊戰 — 這是一個廣泛的話題，涵蓋了從激進駭客主義到為謀取經濟利益的資訊污染。一些資通攻擊我們認定如下：
* 針對ITS基礎設施發起分散式拒絕服務攻擊 (DDoS)，使系統崩潰並導致道路混亂。
* 入侵公司應用程式或網站以發布政治、抗議或惡作劇消息。或可能是損害ITS公司的聲譽和造成財務損失。
* 入侵道路上的動態訊息標誌，以張貼政治、抗議或惡作劇消息。
* 當協作式自動駕駛汽車實際行駛在路上，犯罪分子可能傳輸冒充的V2V消息以製造交通混亂。
* V2V資訊中毒可成為服務，無良企業付錢給犯罪分子在V2V頻道傳送病毒並強制改變路線，使自動駕駛汽車到他們的營業地點。
* 地圖駭客（透過破壞道路基礎的位置發射器，入侵車載 GPS 接收器或 GPS 訊號欺騙）可能會導致自動駕駛汽車偏離航線並引發事故。

系統遊戲和盜竊—對於犯罪者來說，最有吸引力的暴利模式之一是偷竊車內的貨物或貴重物品或車輛本身。其他可能會嘗試利用ITS系統來避免支付服務費。我們確定了以下攻擊：
* 入侵自動駕駛卡車並使其改變路線到某個偏遠地區（例如城外的空曠停車場），罪犯可以在那闖入卡車偷走裡面的貨物。
* 使用被駭的自動駕駛汽車，匿名運送違禁品如毒品和武器。
* 入侵有乘客的自駕車，並指示車輛改變路線停在某個不起眼的地方。罪犯的目標是竊取乘客的貴重物品，甚至綁架某人。
* 入侵自動駕駛汽車，改變路線使車輛停止，用以盜竊車輛零件或車輛本身。
* 利用被破壞的ITS系統以避免支付服務費，例如停車費、過橋費、交通擁堵費等。
* 行動式紅外發射器 (Mobile Infrared Radio Transmitter, MIRT) 設備可以遠端改變具有內建先佔接收器控制的交通號誌。未來可能會有複雜的MIRT式設備，可破壞有利於設備擁有者的流量。
* 不道德的ITS服務供應商（例如，自駕計程車和送貨服務供應商）可能試圖入侵競爭對手的自動駕駛汽車並使其無法使用。
* 在專用車道上非法的為自動駕駛汽車分配更高的優先權，使得其他自動駕駛車輛靠邊。
* 偽造自動駕駛汽車共乘的訂單對毫無戒心的顧客收取費用。

復仇與恐怖主義—恐怖攻擊事件，襲擊者開車撞無辜的人並殺死他們，最近一直在世界各地製造令人不安的新聞頭條。在一個ITS生態系統包括自動駕駛汽車、恐怖攻擊使用自動駕駛汽車仍然是最嚴重和最致命的攻擊之一，我們需要去防範。如果自動駕駛汽車的駕駛功能會受到影響，那麼這些車輛很有可能被用於恐怖攻擊的武器。恐怖攻擊主要針對人們，但我們推測被劫持的車輛也可用於攻擊關鍵基礎設施。恐怖分子可遠端發動這些攻擊，這使得追蹤攻擊者非常困難。曾經成為美國頭條新聞的Bridgegate醜聞，是出於政治報復的動機。工作人員在沒有任何事先公開通知情況下，關閉喬治華盛頓大橋上的車道，根據法律規定，後來被法院定罪。這事件說明內線和報復性攻擊是真實存在，而且很難預測和防禦。這些是我們認為可能的攻擊場景：
* 透過操縱交通流量管控機制故意擾亂交通，如路障、車道號誌、紅綠燈等。最終目標是在道路製造混亂，或在極端情況下造成交通事故。
* 使關鍵ITS安全系統失效，從而危及公共安全。這將影響依賴ITS安全系統的所有運輸模式無法安全行駛在道路。
* 觸發路邊緊急警報系統，例如龍捲風警報器。
* 在線上傾倒敏感資料，危及公司營運及員工的隱私。

從資通安全的角度來看，駭侵ITS系統的一個顯而易見的原因是使用它們作為進入更大的ITS生態系統的入口點。安裝在道路上的ITS系統裝置幾乎任何人都可以存取，透過網際網路或虛擬專用網路(VPN) 再進到ITS生態系統。如果攻擊者可成功利用ITS系統以存取企業網路，他們就可以輕鬆地深入網路內部，因為ITS系統被認為是一個可信任節點。一旦進入網路，入侵者就可以啟動任何我們剛剛描述的攻擊。
...
* Cooperative traffic and position sharing systems — 未來，聯結汽車和自動駕駛汽車將隨意共享它們的位置，並與道路基礎設施共享。ITS 生態系統需要實時處理接收到的車輛位置資料，並與道路網絡的其餘部分和附近的其他連結車輛共享。該位置資料將用於改進安全和控制交通流量。
...
**通訊應用子系統技術**
* Smart apps — 全球智慧型手機擁有率中位數為 43%，已開發國家增加到 50% 以上。在智慧型手機上執行的 ITS 應用程式使用戶更容易支付和使用各種 ITS 服務。應用程式目前用於公車、電子票、交通、共享汽車、貨運、出租車/豪華轎車、停車、旅行計劃、乘車共享、車輛診斷和管理等。
...
* Telematics and eCall —遠程資訊處理服務為駕駛員提供有關路線、交通壅塞、道路障礙物、事故警報、路邊援助和eCall 的資訊。eCall 可以將車輛連接到路邊援助或緊急服務。如果車輛檢測到發生事故，可以手動或自動撥打緊急服務電話。
* Emergency vehicle warning systems — 未來，緊急車輛將能夠向前方車輛的 FM 無線電接收器發送語音警告，建議他們靠邊行駛。此外，V2V/V2I 消息將發出聲音和視覺警告駕駛員讓開緊急車輛。
* Road information displays and alert systems — 在道路標誌架上方安裝電子交通標誌，用於向旅行者顯示重要資訊。這些標誌用於顯示有關交通壅塞、事故或事件、道路工程、限速、等待時間、車道信號等的信息。
* Communication cell towers, antennas, and repeaters — 基地台、天線、及警示系統是 ITS 通信的硬體骨幹。電信公司和 ITS 提供商對通信硬體的安裝、維護和維護有共同的責任。
* I2I, V2V, and V2I communications — 未來，所有連結車輛都將被要求以特別的方式與其他連結車輛和智慧化道路基礎設施進行通信，為它們提供位置資料、安全警告和周圍交通等資訊。通信將使用無線技術完成，例如：3G、4G/LTE、5G、802.11g/n/p、802.16 等。
