...
* Road-based location services for autonomous vehicles — To improve the location accuracy of autonomous vehicles, the ITS ecosystem will have land-based GPS transmitters. These transmitters will transmit their exact location as well as other data including traffic, accident/incident information, weather, etc.為了提高自動駕駛汽車的定位精度，ITS 生態系統將配備陸基 GPS 發射器。這些發射器將傳輸它們的確切位置以及其他資訊，包括交通、事故/事件訊息、天氣等。
