...
* Smart traffic light control systems — 交通號誌智慧控制系統是交通和壅塞管理的子系統。紅綠燈經由公共 IP 網路或 VPN 與 ITS 控制中心通信。控制中心可以改變交通信號的行為以優先考慮緊急和交通車輛，或根據情況需要改變交通信號的行為。
* Commercial vehicle operations — 商用車輛作業系統是貨運公司運作的系統，用於追踪車隊。系統追踪車輛位置，以最有效的方式進行交貨安排和路線安排，處理所有必需的清關文書工作，包括過境，管理通行費和其他附加費的支付等。該系統旨在提高運營效率，降低成本，並增加收入。當自動駕駛卡車開始在道路上行駛時，這些系統將用於協調公路列車以實現超密度運營。
* Maintenance and construction management — 道路及其支援基礎設施需要定期維護，新的道路建設一直規劃中。工程依靠 ITS 數據來計劃和安排維修，並確定新的施工機會。
...
* 未來，聯結汽車和自動駕駛汽車將隨意共享它們的位置，並與道路基礎設施共享。ITS 生態系統需要實時處理接收到的車輛位置資料，並與道路網絡的其餘部分和附近的其他連結車輛共享。該位置資料將用於改進安全和控制交通流量。
* Artificial intelligence (AI) and machine learning (ML) applications — 人工智慧(AI)和機器學習(ML)應用的目的從大數據中提取價值。針對 ITS，AI 和 ML 的目標將提高系統效率、建立交通流量預測模型和建立災害響應模型、識別未來的建設機會、創建新的創收模型、建立改進城市擴張模型、降低成本等。此資料分析對城市規劃者和政府決策者都至關重要。
* Road-based location services for autonomous vehicles — 為了提高自動駕駛汽車的定位精度，ITS 生態系統將配備陸基 GPS 發射器。這些發射器將傳輸它們的確切位置以及其他資訊，包括交通、事故/事件訊息、天氣等。
...
* 全球智慧型手機擁有率中位數為 43%，已開發國家增加到 50% 以上。在智慧型手機上執行的 ITS 應用程式使用戶更容易支付和使用各種 ITS 服務。應用程式目前用於公車、電子票、交通、共享汽車、貨運、出租車/豪華轎車、停車、旅行計劃、乘車共享、車輛診斷和管理等。
* Social media — 越來越多的人口從 Twitter 和 Facebook 等社交媒體平台接收每日新聞。 ITS 運營商定期通過社交媒體平台向公眾更新重要信息，例如交通延誤、罷工等。 
* Company website —與社交媒體一起，公司網站還掌管 ITS 服務的重要用戶資訊。此外，這些網站還提供旅行計劃、購票、罰款支付、日程安排等服務。
* Advertisements —廣告是 ITS 提供商的主要收入來源之一。顯示幕上的數位廣告正在慢慢取代傳統的印刷和海報廣告，儘管預計印刷和海報不會很快完全消失。
* 公車的實時位置及其預計到達/離開時間可通過以下方式提供給用戶，公車站的數位留言板、智慧型手機應用程序、短信和公司網站。 
* 道路障礙和事故警報Road obstacle and accident alerts — 將顯示在高速公路/快速公路上方的動態訊息標誌上。它們被廣播到啟用了交通訊息頻道 (TMC) 的車輛。未來，障礙物和事故警報將通過 V2V 和 V2I 頻道廣播。
...
* 遠程資訊處理服務為駕駛員提供有關路線、交通壅塞、道路障礙物、事故警報、路邊援助和eCall 的資訊。eCall 可以將車輛連接到路邊援助或緊急服務。如果車輛檢測到發生事故，可以手動或自動撥打緊急服務電話。
